 ...
 */
return[
    'userfile_not_set' => 'Unable to find a post variable called userfile.',
    ...
    'invalid_filetype' => 'The filetype you are attempting to upload is not allowed.',
    'invalid_filesize' => 'The file you are attempting to upload is larger than the permitted size.',
    'invalid_dimensions' => 'The image you are attempting to upload doesn\'t fit into the allowed dimensions.',
